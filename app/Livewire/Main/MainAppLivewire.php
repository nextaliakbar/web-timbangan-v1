...
class MainAppLivewire extends Component
{
    ...
    private function saveData()
    {
        ...
        $this->dispatch('alertSaveData', title: 'Sukses', text: 'Proses timbang berhasil disimpan', icon: 'success');
        ...
        $this->dispatch('resetDropdownSelect');
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $this->dispatch('alertError', title: 'Gagal', text: $errorMessage, icon: 'error');
            throw $ex;
        }
    ...
    public function destroy($data)
    {
        ...
        $this->dispatch('alertDeleteData', 'Sukses', text: 'Data barang berhasil dihapus', icon: 'success');
    }
